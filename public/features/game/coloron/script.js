class Game {
  ...
  * Display score
  ...
  showGrade(score) {
    ...
    if (score > 20) return "Tuyệt vời đấy";else
    if (score > 15) return "Tuyệt!";else
    if (score > 13) return "Đẹp thật!";else
    if (score > 10) return "Làm tốt lắm!";else
    if (score > 5) return "Khá đấy?";else
    return "Tiếc thật...";
  }

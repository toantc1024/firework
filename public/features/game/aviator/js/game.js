window.onload = function(){
  if(localStorage.getItem("high-score")===null){
    localStorage.setItem("high-score",2500);
  }
  document.getElementById("hiscore").innerHTML = "Bay xa: "+ localStorage.getItem("high-score") + " mét";
}
//COLORS
var Colors = {
    red:0xf25346,
...
function updateDistance(){
  ...
  fieldDistance.innerHTML = Math.floor(game.distance)+" mét";
  var d = 502*(1-(game.distance%game.distanceForLevelUpdate)/game.distanceForLevelUpdate);
  levelCircle.setAttribute("stroke-dashoffset", d);
  //console.log(Math.floor(game.distance));
  if(game.distance>localStorage.getItem("high-score")){
    localStorage.setItem("high-score",Math.floor(game.distance));
  }
}
